...
const CATALOG: CatalogItem[] = [
  // Desks
  { catalogId: 'desk_basic', name: 'Basic Desk', type: 'desk', price: 200, rarity: 'common', w: 3, h: 3, description: 'A simple desk to get started.' },
  { catalogId: 'desk_dual_monitor', name: 'Dual Monitor Desk', type: 'desk', price: 800, rarity: 'common', w: 3, h: 3, description: 'Two screens, twice the productivity.' },
  { catalogId: 'desk_standing', name: 'Standing Desk', type: 'desk', price: 1200, rarity: 'rare', w: 3, h: 3, description: 'Ergonomic standing desk for the health-conscious.' },
  { catalogId: 'desk_corner_office', name: 'Corner Office Desk', type: 'desk', price: 2000, rarity: 'rare', w: 3, h: 3, description: 'The corner office — a status symbol.' },

  // Facilities — hydration
  { catalogId: 'facility_water_cooler', name: 'Water Cooler', type: 'facility', price: 500, rarity: 'common', category: 'hydration', w: 1, h: 2, description: 'Stay hydrated, stay productive.' },
  { catalogId: 'facility_coffee_machine', name: 'Coffee Machine', type: 'facility', price: 1000, rarity: 'common', category: 'hydration', w: 1, h: 2, description: 'Premium espresso on demand.' },

  // Facilities — food
  { catalogId: 'facility_vending_machine', name: 'Vending Machine', type: 'facility', price: 500, rarity: 'common', category: 'food', w: 1, h: 2, description: 'Snacks for late-night coding.' },
  { catalogId: 'facility_kitchen', name: 'Kitchen', type: 'facility', price: 2000, rarity: 'rare', category: 'food', w: 2, h: 2, description: 'A full kitchen for gourmet fuel.' },

  // Facilities — rest
  { catalogId: 'facility_couch', name: 'Couch', type: 'facility', price: 500, rarity: 'common', category: 'rest', w: 2, h: 1, description: 'A comfy couch for quick breaks.' },
  { catalogId: 'facility_nap_pod', name: 'Nap Pod', type: 'facility', price: 2000, rarity: 'rare', category: 'rest', w: 2, h: 1, description: 'Power naps, Silicon Valley style.' },

  // Facilities — comfort
  { catalogId: 'facility_ergo_desk', name: 'Ergonomic Desk Setup', type: 'facility', price: 1000, rarity: 'common', category: 'comfort', w: 2, h: 2, description: 'Wrist rests, monitor arms, the works.' },
  { catalogId: 'facility_good_lighting', name: 'Good Lighting', type: 'facility', price: 800, rarity: 'common', category: 'comfort', w: 1, h: 1, description: 'Warm, adjustable lighting throughout.' },
  ...
  // Expansions
  { catalogId: 'expand_room', name: 'Expand Width', type: 'expansion', price: 5000, rarity: 'rare', description: 'Add 5 columns to the world grid.' },
  { catalogId: 'expand_room_upgrade', name: 'Room Upgrade', type: 'expansion', price: 3000, rarity: 'common', description: 'Upgrade room aesthetics and capacity.' },
  { catalogId: 'expand_floor', name: 'Expand Height', type: 'expansion', price: 12000, rarity: 'legendary', description: 'Add 5 rows to the world grid.' },
];
