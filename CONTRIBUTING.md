...
nightshift/
  ...
  presets/       # Team presets (agent profiles, defaults)
  defaults/      # Shared default configs
  worlds/        # Visualization world definitions
  examples/      # Example extension sets for different stacks
  docs/          # User-facing documentation
  docs/plans/    # Internal implementation plans (not shipped to npm)
  plans/         # Internal design specs (not shipped to npm)
```
